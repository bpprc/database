...
urlpatterns = [
    ...
    path('download_single_sequence/<str:proteinname>/', views.download_single_sequence, name='download_single_sequence'),
    path('download_category_<str:category>', views.download_category,
         name='download_category'),
    path('protein_detail/<slug:name>/', views.protein_detail, name='protein_detail'),
